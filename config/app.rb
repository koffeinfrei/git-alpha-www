...
Volt.configure do |config|
  ...
  #######################################
  config.domain = 'git-flame.com'
  config.app_name = 'Git_flame'
  config.mailer.from = 'Git_flame <no-reply@git-flame.com>'
  ...
  #
  config.app_secret = 'urshhSUKFOrdWr_CDpbTZRsV72hUC1TMNFpUNH-VMbBF0dFTDBjU5Mz1cC-5X2ECRUI'
